...
@interface OIDExternalUserAgentIOSNoSSO ()<SFSafariViewControllerDelegate, ASWebAuthenticationPresentationContextProviding,ASWebAuthenticationPresentationContextProviding>
@end
#else
...
//  }
  ...
  if (@available(iOS 9.0, *)) {
    if (!openedUserAgent && _presentingViewController) {
      ...
      [safariVC setModalPresentationStyle:UIModalPresentationFullScreen];
      [_presentingViewController setModalPresentationStyle:UIModalPresentationFullScreen];
      openedUserAgent = YES;
    }
  }
...
- (ASPresentationAnchor)presentationAnchorForWebAuthenticationSession:(ASWebAuthenticationSession *)session API_AVAILABLE(ios(13.0)){
    ...
    if (keyWindow) {
        return keyWindow.rootViewController.view.window;
    }
